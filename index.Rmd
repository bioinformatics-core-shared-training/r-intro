...
**Instructors:** Chandra Chilamakuri, Matt Eldridge, Mark Fernandes, Kamal Kishore and Ashley Sawle
<br/>
...
1. [Introduction to R](week1.html) (14 April) - Interacting with R using RStudio and introducing objects, data types, functions and reading in tabular data

2. [Working with data](week2.html) (20 April) - Creating R projects in RStudio, working with tabular data and other types of objects in R
