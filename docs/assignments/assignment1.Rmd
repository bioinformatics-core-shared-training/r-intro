...
data files that future assignments will make use of.
...
As we go through successive assignment on the course, we'll introduce more
features of R markdown. It's a great way of writing R code for analyzing and
visualizing your data that lets you present your work in a beautiful
self-describing reports, a surefire way to impress your group leader and
colleagues alike.
...
much more complicated than this assignment.
