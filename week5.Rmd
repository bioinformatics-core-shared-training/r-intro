...
Finally, we'll combine these data using an `inner_join()`.
...
Having combined the data from two sources we can now carry out exploratory data
analysis that was hitherto not possible.
