...
look at the key functions for slicing and dicing our data, modifying the
contents and computing summary statistics.
...
grammar. These verbs work similarly with the following common behaviour:
...
**Advanced**: `str_detect()` is another useful function that determines whether
values match a regular expression. Regular expressions are a language for search
patterns used very frequently in computer programming.
