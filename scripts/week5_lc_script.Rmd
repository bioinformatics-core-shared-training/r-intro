...
##### What is we want to look at the mean experession of ESR1 in ER+ and ER- patients
...
But dplyr provides a better way - grouping with `group_by`
...
##### We could even group by multiple categories
...
##### It's often useful to have a count of the number of rows in each group
...
###### Think about e.g. the table of mutations, we migth want to add gene annotations....
...
band_instruments4 <- tibble(
    ...
    plays =    c("guitar & vocals", "bass",      "guitar",   "guitar")
)
```
