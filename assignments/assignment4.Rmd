...
Now look at the breakdown of these patients in terms of ER status. Compare that
with the proportion of the entire METABRIC cohort that are ER positive and ER
...
Create a contingency table and perform a Chi-squared test or a Fisher's exact
test (whichever is most appropriate) to determine if there is a significant
difference between the untreated, long-surviving patients and the others.
...
Standardize the expression values for all genes in a single operation with a
lambda expression, overwriting their original values, and round the resulting
